...
export const BetaProgramSection: React.FC = () => {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        setErrorMessage(
          "Failed to register for feedback, please try again later"
        );
      } finally {
      ...
      case "download":
        return (
          <div className="text-center">
            <p className="mb-4">
              Great! You&lsquo;re signed up for the beta program. Click the
              button below to download the app:
            </p>
            <p className="font-bold">
              Also don&apos;t worry we won&apos;t match your feedback to your
              name so be honest as possible it&apos;s important to us
            </p>
            <Button
          ...
          <>
            ...
            <form onSubmit={handleFeedback} className="space-y-4">
              <Label htmlFor="feedback" className="text-left block">
                We&lsquo;d love to hear your thoughts:
              </Label>
              <Textarea
                id="feedback"
        ...
        return (
          <div className="text-center">
            ...
            <p>
              ...
              participation in our beta program.
            </p>
          </div>
        );
    }
  ...
  return (
    <section
      id="beta-program"
      className="py-20 px-4 bg-gradient-to-r from-purple-800 to-pink-800 text-white"
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xl mb-8">
          Join our beta program, test our app, and help shape the future of
          Tick8 Plus. Your feedback is invaluable!
        </p>
        {renderStep()}
      </div>
    </section>
